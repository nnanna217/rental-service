...
class InventoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rate' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'rate' => 1,
            'quantity' => 1,
            'created' => '2015-07-14 08:44:31',
            'modified' => '2015-07-14 08:44:31'
        ],
    ];
}
